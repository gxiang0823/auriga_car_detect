...
#define CLIP_HEIGHT 2.5 //截取掉高于雷达自身0.2米的点
...
#define min_height_threshold_ 0.35
#define local_max_slope_ 6   //max slope of the ground between points, degree
#define general_max_slope_ 4 //max slope of the ground in entire point cloud, degree
